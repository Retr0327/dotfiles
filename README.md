...
| **btop** | 1.4+ | `brew install btop` |
| **Node.js** | 22+ | [nvm](https://github.com/nvm-sh/nvm) |
| **pnpm** | 10+ | `npm install -g pnpm` |
| **Go** | 22+ | [gvm](https://github.com/moovweb/gvm) |
...
| **imagemagick** | 7+ | `brew install imagemagick` (Required for Snacks image module) |
...
# 2. Install all tools
brew install neovim tmux ripgrep fd fzf lazygit btop imagemagick
